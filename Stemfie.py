...
class STR_STD_ERR_Icon:
    ...
    def GetResources(self): 
        return {'Pixmap' : (StemfieWB_icons_path +'/Brace STR STD ERR_icon.png'), 'MenuText': 'STR STD ERR', 'ToolTip': 'Brace - Straight - Ending Round Round'}  
...
class STR_SLT_FL_ERR_Icon:
    ...
    def GetResources(self): 
        return {'Pixmap' : (StemfieWB_icons_path +'/Brace STR SLT FL ERR_icon.png'), 'MenuText': 'STR SLT FL ERR', 'ToolTip': 'Brace - Straight - Slotted - Full Length - Ending Round Round'} 
...
class STR_SLT_SE_ERR_Icon:
    ...
    def GetResources(self): 
        return {'Pixmap' : (StemfieWB_icons_path +'/Brace STR SLT SE ERR_icon.png'), 'MenuText': 'STR SLT SE ERR', 'ToolTip': 'Brace - Straight - Slotted - Single End - Ending Round Round'} 
...
class STR_ESS_Icon:
    ...
    def GetResources(self): 
        return {'Pixmap' : (StemfieWB_icons_path +'/Beam STR ESS_icon.png'), 'MenuText': 'STR ESS', 'ToolTip': 'Beam - Straight - Ending Square/Square'} 
...
class STR_ERR_Icon:
    ...
    def GetResources(self): 
        return {'Pixmap' : (StemfieWB_icons_path +'/Beam STR ERR_icon.png'), 'MenuText': 'STR ERR', 'ToolTip': 'Beam - Straight - Ending Round/Round'} 
...
class THR_H_BEM_SFT_1W_Icon:
    ...
    def GetResources(self): 
        return {'Pixmap' : (StemfieWB_icons_path +'/Conector THR H BEM SFT 1W_icon.png'), 'MenuText': 'THR H BEM SFT 1W', 'ToolTip': 'Conector THR H BEM SFT 1W'} 
...
class THR_H_BEM_SFT_2W_180_Icon:
    ...
    def GetResources(self): 
        return {'Pixmap' : (StemfieWB_icons_path +'/Conector THR H BEM SFT 2W 180_icon.png'), 'MenuText': 'THR H BEM SFT 2W 180º', 'ToolTip': 'Conector THR H BEM SFT 2W 180º'} 
...
class THR_H_BEM_SFT_2W_90_Icon:
    ...
    def GetResources(self): 
        return {'Pixmap' : (StemfieWB_icons_path +'/Conector THR H BEM SFT 2W 90_icon.png'), 'MenuText': 'THR H BEM SFT 2W 90º', 'ToolTip': 'Conector THR H BEM SFT 2W 90º'} 
...
class THR_H_BEM_SFT_3W_Icon:
    ...
    def GetResources(self): 
        return {'Pixmap' : (StemfieWB_icons_path +'/Conector THR H BEM SFT 3W_icon.png'), 'MenuText': 'THR H BEM SFT 3W', 'ToolTip': 'Conector THR H BEM SFT 3W'} 
...
class THR_H_BEM_SFT_4W_Icon:
    ...
    def GetResources(self): 
        return {'Pixmap' : (StemfieWB_icons_path +'/Conector THR H BEM SFT 4W_icon.png'), 'MenuText': 'THR H BEM SFT 4W', 'ToolTip': 'Conector THR H BEM SFT 4W'} 
...
class Cmd_Listado_Icon:
    ...
    def GetResources(self): 
        return {'Pixmap' : (StemfieWB_icons_path +'/Cmd_Listado_icon.png'), 'MenuText': 'Listado Piezas', 'ToolTip': 'Listado Piezas'} 
...
FreeCADGui.addCommand('Brace_STR_SLT_SE_ERR', STR_SLT_SE_ERR_Icon())
...
# Vigas
FreeCADGui.addCommand('Beam_STR_ESS', STR_ESS_Icon())
FreeCADGui.addCommand('Beam_STR_ERR', STR_ERR_Icon())
...
# Conectores
FreeCADGui.addCommand('Conector_THR_H_BEM_SFT_1W', THR_H_BEM_SFT_1W_Icon())
FreeCADGui.addCommand('Conector_THR_H_BEM_SFT_2W_180', THR_H_BEM_SFT_2W_180_Icon())
FreeCADGui.addCommand('Conector_THR_H_BEM_SFT_2W_90', THR_H_BEM_SFT_2W_90_Icon())
FreeCADGui.addCommand('Conector_THR_H_BEM_SFT_3W', THR_H_BEM_SFT_3W_Icon())
FreeCADGui.addCommand('Conector_THR_H_BEM_SFT_4W', THR_H_BEM_SFT_4W_Icon())
# Comandos
FreeCADGui.addCommand('Cmd_Listado', Cmd_Listado_Icon())
